...
class Resources():
	'''
	Abstract class for resources that are loaded/unloaded by copying 
	or deleting files from the addon folder to the blender folder.
	'''
...
class StudioResources(Resources):
	'''
	Expands the load/unload methods of the Resource class, 
	to refresh the sudio_lights panel.
	'''
